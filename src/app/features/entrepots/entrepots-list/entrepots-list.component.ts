...
import { EntrepotControllerService, EntrepotResponse, UtilisateurMarchandControllerService, UtilisateurResponse } from '@/app/modules/openapi';
...
@Component({
    ...
    imports: [CommonModule, FormsModule, TableModule, ButtonModule, TagModule, TooltipModule, ToastModule, ToolbarModule, AvatarModule, AvatarGroupModule, EntrepotFormComponent, AssignerUtilisateurDialogComponent],
